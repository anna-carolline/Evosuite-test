...
public class Util_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.Closeable", false, Util_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.InputStream", false, Util_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.OutputStream", false, Util_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Reader", false, Util_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Writer", false, Util_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.net.Socket", false, Util_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.net.io.CopyStreamListener", false, Util_ESTest_scaffolding.class.getClassLoader()));
  }
