...
public class RCommandClient_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.net.Socket", false, RCommandClient_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.net.SocketFactory", false, RCommandClient_ESTest_scaffolding.class.getClassLoader()));
  }
