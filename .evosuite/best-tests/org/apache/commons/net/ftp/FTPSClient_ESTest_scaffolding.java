...
public class FTPSClient_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("javax.net.ssl.KeyManager", false, FTPSClient_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.net.ssl.SSLContext", false, FTPSClient_ESTest_scaffolding.class.getClassLoader()));
  }
